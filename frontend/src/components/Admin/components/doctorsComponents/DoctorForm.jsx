...
const DoctorForm = ({ doctorCount, setDoctorCount }) => {
    ...
    return (
        <>
            <button onClick={toggleModal} type="button" className="text-white bg-[#3554a4] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2.5 me-2 flex items-center gap-2">Add Doctor<MdAddCircle /></button>
                    ...
                    <div className="relative p-4 w-full max-w-lg scrollbar-hide  max-h-[90%] overflow-auto">
                        <div className="relative bg-white rounded-lg shadow">
                            ...
                            <div className="flex items-center justify-between p-4 border-b text-3xl text-white rounded-t">
                                ...
                                <h1 className="font-bold text-center text-[#3554a4]">Doctor Form</h1>
                            ...
                            <form className="p-8 w-full max-w-lg" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="mb-2">
                                    <label className="block text-[#3554a4] text-xl font-medium">Speciality:</label>
                                    <input
