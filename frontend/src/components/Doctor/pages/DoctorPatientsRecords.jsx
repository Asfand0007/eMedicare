...
import PatientsRow from "../components/patientsComponents/patientComponents/PatientsRow";
import SearchBar from "../../shared/SearchBar";
import PatientCard from "../components/patientsComponents/patientComponents/PatientCard";
...
const DoctorPatientsRecords = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await fetch("http://localhost:4000/api/doctor/getMyPatients/" + searchValue, {
                    method: "GET",
                    headers: {
